...
import stylesCss from 'themes/customTheme/styles.css';
...
export const applyTheme = (target) => {
    ...
    if (!document['_vaadintheme_customTheme_componentCss']) {

        document['_vaadintheme_customTheme_componentCss'] = true;
    }
